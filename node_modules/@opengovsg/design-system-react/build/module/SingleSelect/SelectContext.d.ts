...
export interface SharedSelectContextReturnProps<Item extends ComboboxItem = ComboboxItem> {
...
interface SelectContextReturn<Item extends ComboboxItem = ComboboxItem> extends UseComboboxPropGetters<Item>, UseComboboxState<Item>, Required<SharedSelectContextReturnProps<Item>>, FormControlOptions {
...
export declare const SelectContext: import("react").Context<SelectContextReturn<ComboboxItem> | undefined>;
export declare const useSelectContext: () => SelectContextReturn<ComboboxItem>;
export {};
