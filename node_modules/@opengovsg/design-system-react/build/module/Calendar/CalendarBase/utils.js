import { addDays, differenceInCalendarMonths, startOfDay, subDays, } from 'date-fns';
 ...
 */
export const getYearOptions = () => range(1500, 2500);
/**
 ...
 */
export const getMonthOffsetFromToday = (today, month, year) => {
 ...
 */
export const getNewDateFromKeyPress = (originalDate, key) => {
    switch (key) {
        case 'ArrowUp':
 ...
 */
export const getDateFromClassName = (className, id) => {
 ...
 */
export const generateClassNameForDate = (id, date) => {
