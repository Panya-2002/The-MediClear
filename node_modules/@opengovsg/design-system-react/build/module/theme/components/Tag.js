...
import { createMultiStyleConfigHelpers, defineStyle, mergeThemeOverride, } from '@chakra-ui/react';
...
const variantSubtle = definePartsStyle((props) => {
    return {
        container: mergeThemeOverride(Badge.variants.subtle(props), getSubtleColors(props)),
    };
});
...
const variantSolid = definePartsStyle((props) => {
    return {
        container: mergeThemeOverride(Badge.variants.solid(props), getSolidColors(props)),
    };
});
const variants = {
