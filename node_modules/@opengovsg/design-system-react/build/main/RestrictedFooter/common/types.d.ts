...
import { FlexProps, ResponsiveValue, StyleFunctionProps } from '@chakra-ui/react';
...
export interface RestrictedFooterProps extends SetOptional<RestrictedFooterVariantProps, 'socialMediaLinks' | 'footerIconLink'>, WithSsr {
    /**
