...
exports.getContrastColor = exports.getContrast = exports.meetsWcagAaRatio = void 0;
/**
...
const hexToRgb = (hex) => {
    ...
    const normalizedHex = hex.replace(HEX_SHORTHAND_EXPAND_REGEX, (_m, r, g, b) => r + r + g + g + b + b);
    ...
    return result.slice(1).map((block) => parseInt(block, 16));
};
/**
 * Luminance function.
 * @see https://www.w3.org/TR/WCAG20-TECHS/G17.html
 ...
 */
const meetsWcagAaRatio = (foreground, background) => {
    const contrast = (0, exports.getContrast)(foreground, background);
    if (!contrast)
        return false;
    return contrast >= MIN_WCAG_AA_CONTRAST_RATIO;
};
exports.meetsWcagAaRatio = meetsWcagAaRatio;
/**
...
const getContrastColor = (fg, bg, fallback) => {
    if ((0, exports.meetsWcagAaRatio)(fg, bg)) {
        return fg;
    }
    return fallback;
};
