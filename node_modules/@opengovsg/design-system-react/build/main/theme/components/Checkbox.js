 ...
 */
const parts = anatomy_1.checkboxAnatomy.extend('othersInput', 'othersContainer', 'othersCheckbox');
const { definePartsStyle, defineMultiStyleConfig } = (0, react_1.createMultiStyleConfigHelpers)(parts.keys);
const getColorProps = ({ colorScheme: c }) => {
    switch (c) {
        case 'main':
            return {
                bg: 'white',
...
const baseStyle = definePartsStyle((props) => {
    ...
    return {
        ...
        container: {
            ...
            _focusWithin: Object.assign(Object.assign({}, layerStyles_1.layerStyles.focusRing.default._focusVisible), { outlineOffset: 0 }),
        },
        // Text label
        label: {
            _disabled: {
        ...
        othersInput: (_a = Input_1.Input.variants) === null || _a === void 0 ? void 0 : _a.outline(props),
    };
});
const sizes = {
    xs: definePartsStyle({
...
exports.Checkbox = defineMultiStyleConfig({
    baseStyle,
    sizes,
    defaultProps: {
        colorScheme: 'main',
