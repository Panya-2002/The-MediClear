...
const parts = anatomy_1.menuAnatomy.extend('chevron');
...
const $shadow = (0, react_1.cssVar)('menu-shadow');
const getListItemColors = ({ colorScheme: c }) => {
    switch (c) {
        case 'main': {
            return {
...
const getClearButtonColors = ({ colorScheme: c }) => {
    switch (c) {
        case 'main':
        case 'sub':
        case 'success':
