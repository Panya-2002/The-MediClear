...
const parts = (0, theme_tools_1.anatomy)('pagination').parts('button', 'container', 'separator', 'stepper', 'text');
const { definePartsStyle, defineMultiStyleConfig } = (0, react_1.createMultiStyleConfigHelpers)(parts.keys);
const baseButtonStyling = (0, react_1.defineStyle)({
    h: 'auto',
    border: 'none',
    borderRadius: 'base',
    cursor: 'pointer',
...
const sizes = {
    md: definePartsStyle({
        ...
        button: Object.assign(Object.assign({}, textStyles_1.textStyles['subhead-2']), { p: '0.25rem 0.625rem', minH: 'auto', minW: 'auto' }),
        text: {
            textStyle: 'body-2',
            p: '0.25rem 0.75rem',
        },
...
exports.Pagination = defineMultiStyleConfig({
    baseStyle,
    sizes,
    variants,
    defaultProps: {
