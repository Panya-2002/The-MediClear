...
const parts = anatomy_1.alertAnatomy.extend('close', 'content', 'wrapper');
const { definePartsStyle, defineMultiStyleConfig } = (0, react_1.createMultiStyleConfigHelpers)(parts.keys);
const baseStyle = definePartsStyle({
    title: textStyles_1.textStyles['subhead-1'],
    description: {
        textStyle: 'body-1',
    },
    icon: {
...
const getSubtleColors = ({ colorScheme: c }) => {
    switch (c) {
        case 'error':
            return {
...
exports.Toast = defineMultiStyleConfig({
    baseStyle,
    sizes,
    variants,
    defaultProps: {
