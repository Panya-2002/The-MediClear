...
const parts = (0, theme_tools_1.anatomy)('calendar').parts('container', // overall container
...
'dayOfMonthContainer', 'dayOfMonth', // container for single date
...
const getDayOfMonthColors = ({ isToday, colorScheme: c, isOutsideCurrMonth, }) => {
    switch (c) {
        case 'main':
            return {
...
const baseDayOfMonthContainerStyles = (0, react_1.defineStyle)({
    justifyContent: 'center',
    _focusWithin: { zIndex: 1 },
});
const baseDayOfMonthStyles = (0, react_1.defineStyle)((props) => {
    const { color, activeBg, borderColor, activeColor, hoverBg, selectedBg } = getDayOfMonthColors(props);
    return {
        ...
        _focus: Object.assign({}, layerStyles_1.layerStyles.focusRing.default._focusVisible),
        _disabled: {
            _hover: {
                bg: hoverBg,
            },
...
const xsSmStyle = definePartsStyle({
    ...
    monthYearSelect: Object.assign({ pl: '1rem' }, textStyles_1.textStyles['subhead-2']),
    monthYearDisplay: Object.assign(Object.assign({}, textStyles_1.textStyles['subhead-2']), { pl: '1rem' }),
    calendarContainer: {
        pb: '1rem',
        px: '0.5rem',
        mb: '-1px',
    ...
    todayLink: Object.assign({ textStyle: 'body-2' }, textStyles_1.textStyles['body-2']),
});
const sizes = {
    xs: xsSmStyle,
    sm: xsSmStyle,
    md: definePartsStyle({
        ...
        monthYearSelect: Object.assign({ pl: '1rem' }, textStyles_1.textStyles['subhead-1']),
        monthYearDisplay: Object.assign(Object.assign({}, textStyles_1.textStyles['subhead-1']), { pl: '1rem' }),
        calendarContainer: {
            pb: '1rem',
            px: '0.5rem',
            mb: '-1px',
        ...
        todayLink: Object.assign({ 
            // Both required since link is both a button and a link, and both
            // components override different props.
            textStyle: 'body-1' }, textStyles_1.textStyles['body-1']),
    }),
};
const monthYearDisplayStyles = (0, react_1.defineStyle)({
    borderRadius: 'base',
    color: 'base.content.strong',
    height: 'fit-content',
    py: '0.25rem',
...
const baseStyle = definePartsStyle((props) => ({
    ...
    monthYearSelect: Object.assign(Object.assign({}, monthYearDisplayStyles), { borderColor: 'transparent', cursor: 'pointer', _hover: {
            borderColor: 'transparent',
        }, _focusVisible: Object.assign({}, layerStyles_1.layerStyles.focusRing.default._focusVisible) }),
...
exports.Calendar = defineMultiStyleConfig({
    baseStyle,
    sizes,
    defaultProps: {
        colorScheme: 'main',
